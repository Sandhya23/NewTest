...
public class VechileVerifications {
    ...
    @Given("^I read vehicle reg numbers from files$")
    ...
    public void i_search_for_vehicle_info_by_reg_number() throws Throwable {
        ...
        System.out.println("No.of Vehicles fetced: "+listallVehicleDetails.size());
        ...
        listallVehicleDetails.forEach(vehicle -> {
            try {
                ...
                System.out.println("Check the Registration NUmber" + exp_registrationNumber);

                if ((vehicle.getRegistrationNumber()).equalsIgnoreCase(exp_registrationNumber)) {
                   try {
                       Assert.assertTrue("Vehicle make  matched", (vehicle.getMake()).equals(exp_Make));
                       Assert.assertTrue("Vehicle color matched", (vehicle.getColour()).equals(exp_Colour));
                   } catch(AssertionError e)
                {
                    System.out.println("Exception found: " + e.getMessage()+":Failed");
    ...
    //display the Failed tests after matching the registration number
            System.out.println("Failed Number of Tests:" + errors.size());
    }
